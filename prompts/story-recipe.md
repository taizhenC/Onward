...
| R2 moments not summaries | B | Mar et al. 2021 meta-analysis (150 effects, 33,000+ participants): narrative beats expository text for memory (g = .72) and comprehension (g = .48); the mechanism is causal structure, and scene-over-summary is craft consensus (Hart, Jones, The Moth). |
...
| R4 inert texture | A | Fazio, Dolan & Marsh 2015: transported readers learned errors from stories; plot-central errors were learned best; a warning did not undo it. Documentary ethics (Honest Truths): inconsequential added sound was acceptable, meaning-changing sound was not. |
...
| The fold as contract | A / B | Fazio 2015 (labels do not undo learned errors); Center for Media Engagement: labels did not raise trust, and an in-story explainer was recalled by 66% versus 24% for a header label, which is why the pointer sits by the content. Itemized versus blanket disclosure has no direct evidence. |
