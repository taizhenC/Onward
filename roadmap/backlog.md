...
| P0-04 | Bug Fix | Remove verbatim disclosure echo and close derived-data leaks | Complete | launch-critical | Nothing; closed once all 50 canonical bridges and the demo stopped repeating intake and the governed brief projection, HMAC echo gates, and CI sink registry shut the leaks. |
