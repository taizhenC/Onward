...
telemetry lifecycle with initial match-journey, durable reader-progress, and bounded-feedback producers. Those are meaningful
...
does not yet contain migrations `0004` through `0014`. Local green checks do not
